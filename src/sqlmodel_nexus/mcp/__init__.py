"""MCP (Model Context Protocol) integration for sqlmodel-nexus.
...
from sqlmodel_nexus.mcp.managers import AppResources, MultiAppManager, SingleAppManager
from sqlmodel_nexus.mcp.server import config_simple_mcp_server, create_mcp_server

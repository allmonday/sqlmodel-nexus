...
Usage:
    ...
    from sqlmodel_graphql import DefineSubset
...
SUBSET_REFERENCE = "__sqlmodel_graphql_subset_source__"
...
def _build_config_overrides(config: SubsetConfig) -> dict[str, Any]:
    ...
    from sqlmodel_graphql.context import ExposeAs, SendTo
...
class SubsetMeta(type):
    ...
    def __new__(cls, name: str, bases: tuple, namespace: dict, **kwargs):
        ...
        from sqlmodel_graphql.context import ExposeAs as _ExposeAs
        from sqlmodel_graphql.context import SendTo as _SendTo
